...
import { DataViewLayoutOptions, DataView, DataViewDoc } from 'primereact/dataview'
                ...
                <div class="p-grid">
                    ...
                    <div className="p-col-12 p-md-2" style={{ marginTop: '40px' }}>
                        <div className="p-inputgroup">
                            <Button disabled={this.state.tooltip !== null} className="p-button-success" label="Добавить в корзину" onClick={(e) => this.addToCart(car)} tooltipOptions={{ position: 'left' }} tooltip={this.state.tooltip} />
            ...
            return (
                <div className="p-grid" style={{ fontSize: '16px', textAlign: 'center', padding: '20px' }}>
                    <div className="p-col-12" style={{ textAlign: 'center' }}>
                        <img src={`data:image/jpeg;base64,${this.state.selectedCar.image}`} style={{ width: '100%', height: 'auto' }} />
                    </div>
        ...
        return (
            <div className="p-grid p-align-center">
                <div className="p-col-7" style={{ textAlign: 'left' }}>
                    <Dropdown options={sortOptions} value={this.state.sortKey} placeholder="Сортировать по" onChange={this.onSortChange} style={{ minWidth: '150px' }} />
                </div>
                <div className="p-col-5 p-grid p-align-center p-justify-end" style={{ marginTop: '0' }}>
                    ...
                    <DataViewLayoutOptions layout={this.state.layout} onChange={(e) => this.setState({ layout: e.value })} style={{ paddingLeft: '10px' }} />
                </div>
            </div>
        );
    }
        ...
        return (
            <div>
                ...
                <div className="content-section implementation">
                    ...
                    <DataView style={{ display: this.state.progress ? 'none' : 'block' }} value={this.state.shownBooks} layout={this.state.layout} header={header}
                        itemTemplate={this.itemTemplate} paginatorPosition={'both'} paginator={true} rows={4}
                        sortOrder={this.state.sortOrder} sortField={this.state.sortField} emptyMessage="Книжек нет :(" />

                    <Dialog header="Подробненько..." visible={this.state.visible} width="400px" modal={true} onHide={() => this.setState({ visible: false })}>
